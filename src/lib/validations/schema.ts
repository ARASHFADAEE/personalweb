...
export const settingsSchema = z.object({
  ...
  blogSeoTitle: z.string().max(120),
  blogSeoDescription: z.string().max(300),
  projectsSeoTitle: z.string().max(120),
  projectsSeoDescription: z.string().max(300),
  aboutSeoTitle: z.string().max(120),
  aboutSeoDescription: z.string().max(300),
  defaultOgImage: z.string().max(500).optional().or(z.literal("")),
